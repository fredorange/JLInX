 ...
 * @author fzql9967
 */
public class IndivoInternalError extends IndivoError {

  protected IndivoInternalError() {
  }

  public IndivoInternalError(String msg) {
    super(msg);
  }

  public IndivoInternalError(String msg, Throwable t) {
    super(msg, t);
  }
}
